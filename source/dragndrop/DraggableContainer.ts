...
export class DraggableContainer implements OnInit, OnDestroy, AfterViewInit
{
	...
	ngOnInit()
	{
		...
		this.zone.runOutsideAngular(() => {
			...
			this.hostElement.nativeElement.addEventListener("dragover", this.onDragOver.bind(this));
			this.hostElement.nativeElement.addEventListener("dragenter", this.onDragEnter.bind(this));
			this.hostElement.nativeElement.addEventListener("dragleave", this.onDragLeave.bind(this));

			this.hostElement.nativeElement.addEventListener("dragstart", this.onDragStart.bind(this));
			this.hostElement.nativeElement.addEventListener("drop", this.onDragDrop.bind(this));
			this.hostElement.nativeElement.addEventListener("dragend", this.onDragEnd.bind(this));

			this.hostElement.nativeElement.addEventListener("selectstart", this.onSelectStart.bind(this));

			this.hostElement.nativeElement.addEventListener("touchstart", this.onTouchStart.bind(this), false);
			this.hostElement.nativeElement.addEventListener("touchend", this.onTouchEnd.bind(this), false);
			this.hostElement.nativeElement.addEventListener("touchmove", this.onTouchMove.bind(this), false);
	...
	ngOnDestroy()
	{
		...
		this.zone.runOutsideAngular(() => {
			this.hostElement.nativeElement.removeEventListener("dragover", this.onDragOver.bind(this));
			this.hostElement.nativeElement.removeEventListener("dragenter", this.onDragEnter.bind(this));
			this.hostElement.nativeElement.removeEventListener("dragleave", this.onDragLeave.bind(this));
			
			this.hostElement.nativeElement.removeEventListener("dragstart", this.onDragStart.bind(this));
			this.hostElement.nativeElement.removeEventListener("drop", this.onDragDrop.bind(this));
			this.hostElement.nativeElement.removeEventListener("dragend", this.onDragEnd.bind(this));

			this.hostElement.nativeElement.removeEventListener("selectstart", this.onSelectStart.bind(this));

			this.hostElement.nativeElement.removeEventListener("touchstart", this.onTouchStart.bind(this));
			this.hostElement.nativeElement.removeEventListener("touchend", this.onTouchEnd.bind(this));
			this.hostElement.nativeElement.removeEventListener("touchmove", this.onTouchMove.bind(this));
		});
	}
	...
	onTouchStart(e: TouchEvent)
	{
		...
		this.zone.runOutsideAngular(() => {
			...
			this.touchDragTimer = setTimeout(() => {
				...
				this.dragService.startEmulatedDrag(draggedItem, this, e.touches[0].clientX, e.touches[0].clientY);
	...
	onTouchMove(e)
	{
		...
		if(this.dragService.isTouchActive)
		{
			...
			this.dragService.emulateScroll(e.touches[0].clientX, e.touches[0].clientY);
			this.dragService.emulateDrag(e.touches[0].clientX, e.touches[0].clientY);
			...
			let targetContainer = this.dragService.findContainer((container :DraggableContainer) => {
				return container.getDraggableItem(target) != null || container.hostElement.nativeElement == target;
			});
	...
	dragAndDrop(target)
	{
		...
		if(!targetItem && this.draggableItems.length > 0)
			return;
		...
		if(this.containerType != this.dragService.draggedItemContainer.containerType)
			return;
	...
	isDraggable(element: Element): boolean
	{
		...
		if(element.parentElement == this.hostElement.nativeElement)
			return true;
		return false;
	}
